...
{
	{
		...
		L_0 = Dictionary_2_get_Values_m635264DB1B9145B6BD680D853F4AF4B75D509C86(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 59));
		return (RuntimeObject*)L_0;
	}
}
...
IL_0009:
	...
	try
	{
		...
		try
		{
			RuntimeObject* L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_m7D564B712DA57A7F1A3F54630803E1278D5BE971(__this, L_3, ((*(Matrix4x4_tDB70CF134A14BA38190C59AA700BCE10E2AED3E6*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 63));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
